  ...
  if (body.jobState && typeof body.jobState === "object") {
    for (const [jobId, patch] of Object.entries(body.jobState)) {
      ...
      next.jobState[jobId] = {
        ...
        smsSentAt:
          patch.smsSentAt === null
            ? undefined
            : typeof patch.smsSentAt === "number" && Number.isFinite(patch.smsSentAt)
              ? patch.smsSentAt
              : prev.smsSentAt,
        paymentType:
          typeof patch.paymentType === "string" && isPaymentType(patch.paymentType)
            ? patch.paymentType
            : prev.paymentType,
        skipped: typeof patch.skipped === "boolean" ? patch.skipped : prev.skipped,
      };
    }
  }
