...
export function ReviewClient() {
  ...
  if (removed.length === 0) {
    return (
      <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold text-zinc-900">Nothing to review.</p>
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                {c ? (
                  <>
                    <p className="mt-0.5 line-clamp-2 text-sm text-zinc-600">{c.address}</p>
                ...
                <p className="mt-2 text-xs font-semibold uppercase tracking-wide text-zinc-500">
                  Removed from week (due {formatDisplayDate(r.dueDate)})
                </p>
              </div>
              ...
              <button
                ...
                className="h-10 shrink-0 rounded-full border border-zinc-200 bg-white px-3 text-sm font-semibold text-zinc-900 shadow-sm hover:bg-zinc-50 disabled:opacity-40"
